...
- My public projects: <ul id="repo-list"></ul><script src="./GetReposbyUsername/GetReposbyUsername.js"></script><script>GetReposbyUsername("jgc777", document.getElementById('repo-list'))</script>
- My github stats:
