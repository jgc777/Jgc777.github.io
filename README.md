...
<ul style="list-style: none;"><li><ul id="repo-list" style="list-style: disc;"></ul></li></ul><script src="./GitHubRepoAPI/demo/defaultapi.js"></script><script>appendRepos("jgc777", document.getElementById('repo-list'));</script>
